...
public interface WebserviceBuilder {
     ...
     */
    enum ApiNames {
        register, login, logout, getUserInfo, profile, forgotPassword, changePassword, addAddress,
        editAddress, updateUserInfo, getCategories, getProducts, productDetails, addToCart,
        removeFromCart, getCartList, updateProductQTY, addToWishList, removeWishList,
        getWishList, getFilterOptions, applyFilterOptions, getAllOrders, getOrderDetails, getDelivery, finalizeOrder, loadMore,
        getNotifications, sendToken
    }
