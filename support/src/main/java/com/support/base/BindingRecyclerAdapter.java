...
/**
 * @param <T> this is POJO model for the list and view model
 * @param <U> this is binding object
 */
public abstract class BindingRecyclerAdapter<T, U extends ViewDataBinding>
        extends RecyclerView.Adapter<BindingRecyclerAdapter<T, U>.MyViewHolder> {
